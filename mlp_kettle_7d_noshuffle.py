...
# --- time-ordered split (same strategy as logistic: ensure both classes in test)
...
# threshold sweep: maximize precision s.t. recall>=RECALL_MIN
cands = []
...
print("\n=== MLP (7d, no shuffle) ===")
print(f"AUC={auc if not np.isnan(auc) else 'NA'}")
